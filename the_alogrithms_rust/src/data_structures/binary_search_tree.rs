...
/// this struct implements as binary search tree, which is a
    ...
    T: Ord,
{
    ...
    /// find a vlaue in this tree. Returns True if value is in this
    ...
    /// insert a vlaue into the appropriate location in this tree
...
mod test {
    ...
    #[test]
    fn binary_search_tree_test_search(){
    ...
    #[test]
    fn binary_search_tree_test_maximum_and_minimum(){
        let tree = prequel_memes_tree();
    ...
    #[test]
    fn binary_search_tree_test_iterator() {
        let tree = prequel_memes_tree();
